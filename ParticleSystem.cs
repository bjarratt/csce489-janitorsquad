...
namespace GameStateManagement
{
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        protected ParticleSystem(Game game, int howManyEffects, SpriteBatch spriteBatch)
            : base(game)
        {
            this.game = game;
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                GameplayScreen.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity =
                GameplayScreen.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                GameplayScreen.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                GameplayScreen.RandomBetween(minLifetime, maxLifetime);
            float scale =
                GameplayScreen.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                GameplayScreen.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = GameplayScreen.RandomBetween(0, MathHelper.TwoPi);
        ...
        public override void Draw(GameTime gameTime)//, SpriteBatch spriteBatch)
        {
            ...
            // initializeConstants
            this.spriteBatch.Begin(spriteBlendMode);
            ...
            foreach (Particle p in particles)
            {
                ...
                this.spriteBatch.Draw(texture, p.Position, null, color,
